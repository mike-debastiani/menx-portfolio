...
export default function AboutHeroSection({
  ...
  return (
    <section className={className}>
      <Container>
        <Grid className="pt-12 pb-10 md:pt-20 md:pb-18">
          ...
          <ScrollReveal
            className="about-hero-description col-span-4 md:col-span-3 lg:col-span-6 xl:col-span-6 order-2 md:order-1 mt-8 md:mt-0"
          >
            <AboutDescription
          ...
          {image && (
            <ScrollReveal
              className="about-hero-image col-span-4 md:col-start-4 md:col-span-3 lg:col-start-10 lg:col-span-3 xl:col-start-10 xl:col-span-3 2xl:col-start-10 2xl:col-span-3 order-1 md:order-2"
            >
